        ...
        <div id="about" uk-scrollspy="target: > div; cls:uk-animation-fade; delay: 500" className="uk-section uk-background-default uk-dark about">
            <div className="uk-container">
                ...
                <div className="container uk-padding uk-padding-remove-bottom">
                    ...
                    <p>I want to grow with a great team of people to share knowledge and get to a point where I will be able to create my own tech company that addresses problems in the healthcare industry.</p>
